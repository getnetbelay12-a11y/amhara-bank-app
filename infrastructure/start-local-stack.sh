...
MONGODB_URI="${MONGODB_URI:-mongodb://localhost:27017/amhara_bank_app}"
...
echo "  Member login:       AMH-100001 / demo-pass"
echo "  Member PIN flow:    start-login with AMH-100001, then PIN 1234"
echo "  Staff admin:        admin.head-office@amharabank.com / demo-pass"
echo "  Staff district:     manager.north-district@amharabank.com / demo-pass"
echo "  Staff branch:       manager.bahirdar-branch@amharabank.com / demo-pass"
echo
echo "Logs"
