...
export class FallbackSchoolConsoleApi implements SchoolConsoleApi {
  ...
  async createFeePlan(payload: {
    ...
    try {
      return await this.primary.createFeePlan(payload);
    } catch {
      return this.fallback.createFeePlan(payload);
    }
  }
  ...
  async createGuardian(payload: {
    ...
    try {
      return await this.primary.createGuardian(payload);
    } catch {
      return this.fallback.createGuardian(payload);
    }
  }
  ...
  async updateGuardian(
    ...
    try {
      return await this.primary.updateGuardian(guardianId, payload);
    } catch {
      return this.fallback.updateGuardian(guardianId, payload);
    }
  }
  ...
  async createGuardianStudentLink(payload: {
    ...
    try {
      return await this.primary.createGuardianStudentLink(payload);
    } catch {
      return this.fallback.createGuardianStudentLink(payload);
    }
  }
  ...
  async updateGuardianStudentLink(
    ...
    try {
      return await this.primary.updateGuardianStudentLink(linkId, payload);
    } catch {
      return this.fallback.updateGuardianStudentLink(linkId, payload);
    }
  }
  ...
  async sendInvoiceReminder(invoiceNo: string) {
    try {
      return await this.primary.sendInvoiceReminder(invoiceNo);
    } catch {
      return this.fallback.sendInvoiceReminder(invoiceNo);
    }
  }

  async sendInvoiceReminders(invoiceNos: string[]) {
    try {
      return await this.primary.sendInvoiceReminders(invoiceNos);
    } catch {
      return this.fallback.sendInvoiceReminders(invoiceNos);
    }
  }
  ...
  async generateInvoiceBatch(payload: {
    ...
    try {
      return await this.primary.generateInvoiceBatch(payload);
    } catch {
      return this.fallback.generateInvoiceBatch(payload);
    }
  }
  ...
  async createSchool(payload: {
    ...
    try {
      return await this.primary.createSchool(payload);
    } catch {
      return this.fallback.createSchool(payload);
    }
  }

  async importStudents(payload: { schoolId: string; students: StudentImportRowInput[] }) {
    try {
      return await this.primary.importStudents(payload);
    } catch {
      return this.fallback.importStudents(payload);
    }
  }
}
