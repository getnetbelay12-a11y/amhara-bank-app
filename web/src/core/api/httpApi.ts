...
const ACCESS_TOKEN_KEY = 'amhara_access_token';
const REFRESH_TOKEN_KEY = 'amhara_refresh_token';
const LEGACY_ACCESS_TOKEN_KEY = 'amhara_access_token';
const LEGACY_REFRESH_TOKEN_KEY = 'amhara_refresh_token';
