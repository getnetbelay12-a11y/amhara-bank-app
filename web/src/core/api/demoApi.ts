    ...
    return {
      ...
      messages: [
        ...
        },
        {
          ...
          senderName: chatId === 'chat_open_1' ? 'Amhara Bank Assistant' : 'Rahel Desta',
          message:
              chatId === 'chat_open_1'
...
export class DemoParentPortalApi implements ParentPortalApi {
  ...
  private currentCustomerId = 'AMH-100001';
  ...
  async getCustomerProfile(loanId: string) {
    ...
    if (loanId === 'loan_1') {
      return {
        ...
        districtId: 'district_amhara_north',
        activeLoans: 1,
        closedLoans: 2,
        rejectedLoans: 0,
        totalLoanCount: 3,
...
export class DemoDashboardApi implements DashboardApi {
  ...
  async updateOnboardingReview(
    ...
    return {
      memberId,
      customerId: memberId === abebeMemberId ? 'AMH-100001' : 'AMH-100003',
...
function demoHeadOfficeDistricts(period: PerformancePeriod = 'week'): RolePerformanceItem[] {
  const baseItems = [
    ...
    createDemoPerformanceItem('district', 'Mekelle District', 69, {
      membersServed: 2336,
  ...
  async getTemplates(): Promise<NotificationTemplateItem[]> {
    ...
    return [
      ...
      },
      {
        ...
        messageBody:
          'Your school fee is due soon. Open the Amhara Bank app to review the student profile and complete payment.',
        channelDefaults: ['mobile_push', 'email', 'sms'],
        isActive: true,
      },
      {
    ...
    return [
      {
        ...
        targetIds: ['AMH-100001', 'AMH-100003'],
