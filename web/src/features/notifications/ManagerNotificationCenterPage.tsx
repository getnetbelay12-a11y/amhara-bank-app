...
export function ManagerNotificationCenterPage({
  ...
  const previewCaption =
    category === 'loan'
      ? 'Amhara Bank loan reminder preview for linked customer channels.'
      : category === 'insurance'
        ? 'Amhara Bank insurance renewal reminder preview for linked customer channels.'
        : category === 'payment'
          ? 'Amhara Bank payment alert preview for linked customer channels.'
          : category === 'support'
            ? 'Amhara Bank support alert preview for linked customer channels.'
            : category === 'security'
              ? 'Amhara Bank security alert preview for linked customer channels.'
              : category === 'system'
                ? 'Amhara Bank system announcement preview for linked customer channels.'
        : category === 'kyc'
          ? 'Amhara Bank KYC reminder preview for linked customer channels.'
          : category === 'shareholder'
            ? 'Amhara Bank shareholder governance preview for eligible members.'
            : 'Amhara Bank AutoPay failure reminder preview for linked customer channels.';
...
function buildTelegramPreview(category: NotificationCategory) {
  if (category === 'insurance') {
    return [
      ...
      'Policy Number: AMH-100001-INS-001',
...
function buildReminderPreview(
  ...
  if (category === 'insurance') {
    return {
      ...
      details: [
        ...
        { label: 'Provider', value: 'Amhara Insurance' },
        { label: 'Policy Number', value: 'AMH-100001-INS-001' },
        { label: 'Renewal Due Date', value: 'March 19, 2026' },
      ],
      amharicDetails: [
        { label: 'ደንበኛ', value: 'Abebe Kebede' },
        { label: 'አቅራቢ', value: 'Amhara Insurance' },
        { label: 'ፖሊሲ ቁጥር', value: 'AMH-100001-INS-001' },
        { label: 'የማደስ ቀን', value: 'March 19, 2026' },
      ],
      englishFooter: 'Thank you, Insurance Service Department, Amhara Bank.',
  ...
  if (category === 'kyc') {
    return {
      ...
      details: [
        ...
        { label: 'Customer ID', value: 'AMH-100004' },
  ...
  return {
    ...
    englishFooter: 'Thank you, Loan Service Department, Amhara Bank.',
  ...
  return (
    ...
    >
      ...
      <div className="muted" style={{ marginBottom: 10 }}>
        Telegram reminders are delivered only to customers who have connected the Amhara Bank Telegram bot.
      </div>
      <pre
        style={{
          margin: 0,
