...
export function ParentPortalPage() {
  ...
  const [customerId, setCustomerId] = useState('AMH-100001');
  ...
  function handleGenerateQr() {
    ...
    const deepLink = `amharabank://school-pay?invoice=${encodeURIComponent(
  ...
  return (
    <div className="standalone-page">
      <div className="page-stack" style={{ width: 'min(1200px, 100%)' }}>
            ...
            <form className="loan-detail-grid" onSubmit={(event) => void handleLogin(event)}>
              ...
              <div className="form-stack">
                <div className="dashboard-summary-chip">
                  ...
                  <strong>AMH-100001 / demo-pass</strong>
                </div>
        ...
        >
          <SimpleTable
            headers={['Student', 'School', 'Grade', 'Guardian', 'Status', 'Open']}
...
function downloadReceipt(
  ...
  const lines = [
    'Amhara Bank School Payment Receipt',
