...
Build and maintain the Amhara Bank app PoC as a modular full-stack project with:
- NestJS backend
...
Defaults:
- local: `mongodb://localhost:27017/amhara_bank_app`
- Atlas: `mongodb+srv://<username>:<password>@cluster.mongodb.net/amhara_bank_app`
