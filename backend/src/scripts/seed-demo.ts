...
async function run() {
  ...
  await StaffModel.insertMany([
    {
      ...
      identifier: 'admin.head-office@amharabank.com',
      phone: '0911001001',
      email: 'admin.head-office@amharabank.com',
      role: UserRole.ADMIN,
    ...
    },
    {
      ...
      identifier: 'manager.head-office@amharabank.com',
      phone: '0911001007',
      email: 'manager.head-office@amharabank.com',
    ...
    },
    {
      ...
      identifier: 'manager.north-district@amharabank.com',
      phone: '0911001002',
      email: 'manager.north-district@amharabank.com',
    ...
    },
    {
      ...
      fullName: 'Hana Worku',
      identifier: 'manager.bahirdar-branch@amharabank.com',
      phone: '0911001003',
      email: 'manager.bahirdar-branch@amharabank.com',
    ...
    },
    {
      ...
      identifier: 'agent.support@amharabank.com',
      phone: '0911001006',
      email: 'agent.support@amharabank.com',
    ...
    },
    {
      ...
      phone: '0911001004',
      email: 'getachew@amhara-bank.local',
    ...
    },
    {
      ...
      phone: '0911001005',
      email: 'tigist@amhara-bank.local',
      role: UserRole.LOAN_OFFICER,
    ...
    },
    {
      ...
      phone: '0911001010',
      email: 'bereket@amhara-bank.local',
      role: UserRole.LOAN_OFFICER,
    ...
    },
    {
      ...
      phone: '0911001011',
      email: 'fitsum@amhara-bank.local',
      role: UserRole.LOAN_OFFICER,
  ...
  await MemberModel.insertMany([
    ...
    },
    {
      ...
      customerId: 'AMH-100002',
      memberNumber: 'AMH-100002',
      memberType: MemberType.SHAREHOLDER,
      role: UserRole.SHAREHOLDER_MEMBER,
      ...
      lastName: 'Bekele',
      phone: '0911000002',
      email: 'tirunesh@amhara-bank.local',
      branchId: debreMarkosBranchId,
      districtId: bahirDarDistrictId,
      shareBalance: 180000,
      kycStatus: 'verified',
    ...
    {
      _id: regularMemberId,
      customerId: 'AMH-100003',
      memberNumber: 'AMH-100003',
      ...
      lastName: 'Alemu',
      phone: '0911000003',
      email: 'meseret@amhara-bank.local',
      branchId: gondarBranchId,
      districtId: gondarDistrictId,
      shareBalance: 0,
    ...
    },
    {
      ...
      customerId: 'AMH-100004',
      memberNumber: 'AMH-100004',
      memberType: MemberType.MEMBER,
      role: UserRole.MEMBER,
      ...
      lastName: 'Worku',
      phone: '0911000004',
      email: 'yohannes@amhara-bank.local',
      branchId: bahirDarBranchId,
      districtId: bahirDarDistrictId,
      shareBalance: 0,
      kycStatus: 'verified',
    ...
    },
    {
      ...
      customerId: 'AMH-100005',
      memberNumber: 'AMH-100005',
      memberType: MemberType.MEMBER,
      role: UserRole.MEMBER,
    ...
    },
    {
      ...
      customerId: 'AMH-100006',
      memberNumber: 'AMH-100006',
      memberType: MemberType.MEMBER,
      role: UserRole.MEMBER,
      ...
      lastName: 'Teshome',
      phone: '0911000006',
      email: 'martha@amhara-bank.local',
      branchId: bahirDarBranchId,
      districtId: bahirDarDistrictId,
      shareBalance: 0,
      kycStatus: 'verified',
    ...
    },
    {
      ...
      customerId: 'AMH-100007',
      memberNumber: 'AMH-100007',
      memberType: MemberType.MEMBER,
      role: UserRole.MEMBER,
      ...
      lastName: 'Asmare',
      phone: '0911000007',
      email: 'biniam@amhara-bank.local',
      branchId: debreMarkosBranchId,
      districtId: bahirDarDistrictId,
      shareBalance: 0,
    ...
    },
    {
      ...
      customerId: 'AMH-100008',
      memberNumber: 'AMH-100008',
      memberType: MemberType.MEMBER,
      role: UserRole.MEMBER,
  ...
  await TransactionModel.insertMany([
    {
      ...
      transactionReference: 'TXN-AMH-2026-001',
      memberId: shareholderMemberId,
    ...
    {
      _id: new Types.ObjectId(),
      transactionReference: 'TXN-AMH-2026-002',
      memberId: shareholderMemberId,
      accountId: shareholderSavingsId,
      branchId: bahirDarBranchId,
    ...
    {
      _id: new Types.ObjectId(),
      transactionReference: 'TXN-AMH-2026-003',
      memberId: shareholderMemberId,
      accountId: shareholderSavingsId,
      branchId: bahirDarBranchId,
    ...
    {
      _id: new Types.ObjectId(),
      transactionReference: 'TXN-AMH-2026-004',
      memberId: secondShareholderMemberId,
    ...
    {
      _id: new Types.ObjectId(),
      transactionReference: 'TXN-AMH-2026-005',
      memberId: secondShareholderMemberId,
      accountId: secondShareholderSavingsId,
      branchId: debreMarkosBranchId,
      type: PaymentType.DEPOSIT,
    ...
    {
      _id: new Types.ObjectId(),
      transactionReference: 'TXN-AMH-2026-006',
      memberId: secondShareholderMemberId,
      accountId: secondShareholderSavingsId,
      branchId: debreMarkosBranchId,
      type: PaymentType.DEPOSIT,
    ...
    {
      _id: new Types.ObjectId(),
      transactionReference: 'TXN-AMH-2026-007',
      memberId: regularMemberId,
    ...
    {
      _id: new Types.ObjectId(),
      transactionReference: 'TXN-AMH-2026-008',
      memberId: regularMemberId,
      accountId: regularSavingsId,
      branchId: gondarBranchId,
      type: PaymentType.SCHOOL_PAYMENT,
    ...
    {
      _id: new Types.ObjectId(),
      transactionReference: 'TXN-AMH-2026-009',
      memberId: secondRegularMemberId,
    ...
    {
      _id: new Types.ObjectId(),
      transactionReference: 'TXN-AMH-2026-010',
      memberId: secondRegularMemberId,
      accountId: secondRegularSavingsId,
      branchId: bahirDarBranchId,
      type: PaymentType.LOAN_REPAYMENT,
    ...
    {
      _id: new Types.ObjectId(),
      transactionReference: 'TXN-AMH-2026-011',
      memberId: thirdRegularMemberId,
    ...
    {
      _id: new Types.ObjectId(),
      transactionReference: 'TXN-AMH-2026-012',
      memberId: thirdRegularMemberId,
      accountId: thirdRegularSavingsId,
      branchId: debreMarkosBranchId,
      type: PaymentType.TRANSFER,
    ...
    {
      _id: new Types.ObjectId(),
      transactionReference: 'TXN-AMH-2026-013',
      memberId: thirdRegularMemberId,
      accountId: thirdRegularSavingsId,
      branchId: debreMarkosBranchId,
      type: PaymentType.SCHOOL_PAYMENT,
  ...
  await ServiceRequestModel.insertMany([
    ...
    },
    {
      ...
      payload: {
        ...
        relatedMemberNumber: 'AMH-100005',
        relatedCustomerId: 'AMH-100005',
      },
  ...
  await NotificationLogModel.insertMany([
    ...
    },
    {
      ...
      category: 'insurance',
      channel: 'email',
      recipient: 'lulit@amhara-bank.local',
      status: 'delivered',
    ...
    JSON.stringify(
      {
        ...
        staffLogins: [
          { identifier: 'admin.head-office@amharabank.com', password: 'demo-pass', role: 'admin' },
          {
            identifier: 'manager.head-office@amharabank.com',
            password: 'demo-pass',
