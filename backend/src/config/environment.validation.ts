...
const CURRENT_DATABASE_NAME = 'amhara_bank_app';
...
export function validateEnvironment(config: EnvironmentRecord): EnvironmentRecord {
  ...
  return {
    ...
    PORT: port,
    DEMO_MODE: demoMode,
    APP_NAME: readString(config, 'APP_NAME', 'Amhara Bank API'),
    ...
    EMAIL_SENDER: readString(config, 'EMAIL_SENDER', 'notifications@amhara-bank.local'),
    ...
    PUSH_IOS_SIMULATOR_BUNDLE_ID: readString(
      ...
      'com.getnetbelay.amharaBankMobile',
    ),
