...
export const NOTIFICATION_TEMPLATE_DEFINITIONS: NotificationTemplateDefinition[] = [
  ...
  },
  {
    ...
    messageBody: 'A new sign-in to your Amhara Bank profile was detected.',
  ...
  },
  {
    ...
    title: 'Announcement',
    subject: 'Amhara Bank Announcement',
    messageBody: 'A new announcement is available in your Amhara Bank app.',
    channelDefaults: [NotificationChannel.MOBILE_PUSH, NotificationChannel.EMAIL],
    templateFile: 'loan_payment_reminder.html',
  },
  {
    ...
    messageBody:
      'A shareholder voting event or governance update is available in your Amhara Bank app.',
    channelDefaults: [NotificationChannel.MOBILE_PUSH, NotificationChannel.EMAIL],
    templateFile: 'loan_payment_reminder.html',
  },
];
