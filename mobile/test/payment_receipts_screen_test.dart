import 'package:amhara_bank_mobile/src/app/app_controller.dart';
import 'package:amhara_bank_mobile/src/app/app_scope.dart';
import 'package:amhara_bank_mobile/src/core/models/index.dart';
import 'package:amhara_bank_mobile/src/core/services/app_services.dart';
import 'package:amhara_bank_mobile/src/core/services/api_contracts.dart';
import 'package:amhara_bank_mobile/src/core/services/session_store.dart';
import 'package:amhara_bank_mobile/src/features/payments/presentation/payments_screen.dart';
import 'package:amhara_bank_mobile/src/features/payments/presentation/payment_receipts_screen.dart';
...
void main() {
  ...
  testWidgets('payment receipts screen shows summary, confirmed payments, and dispute evidence',
      (tester) async {
    ...
    expect(find.text('Customer ID: AMH-100001 · Bahir Dar Branch'), findsOneWidget);
    ...
    expect(find.textContaining('Evidence: Awaiting receipt upload'), findsOneWidget);
    expect(find.textContaining('Evidence: transfer_receipt.png'), findsOneWidget);
