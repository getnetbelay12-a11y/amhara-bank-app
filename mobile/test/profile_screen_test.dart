...
import 'package:amhara_bank_mobile/src/features/profile/presentation/profile_screen.dart';
import 'package:amhara_bank_mobile/src/shared/widgets/app_new_badge.dart';
...
class _TestMemberApi implements MemberApi {
  ...
  Future<MemberProfile> fetchMyProfile(String memberId) async {
    return MemberProfile(
      memberId: memberId,
      customerId: memberId == 'member_1' ? 'AMH-100001' : 'AMH-100002',
