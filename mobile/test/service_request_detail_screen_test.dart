...
import 'package:amhara_bank_mobile/src/features/service_requests/presentation/service_request_detail_screen.dart';
...
void main() {
  ...
  testWidgets('service request detail shows account relationship metadata', (tester) async {
    ...
    expect(find.text('AMH-100112'), findsNWidgets(2));
    expect(find.text('Attachments'), findsOneWidget);
