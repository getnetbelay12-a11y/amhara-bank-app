...
class _HomeDashboardScreenState extends State<HomeDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<MemberHomeData>(
      ...
      builder: (context, snapshot) {
        ...
        final insights = homeData?.insights.items.take(2).toList() ?? const <SmartInsight>[];
        final allNotifications = homeData?.notifications ?? const <AppNotification>[];
                ...
                GridView.count(
                  ...
                  children: [
                    ...
                    _QuickAction(
                      ...
                      label: 'Telebirr',
                      onTap: () => _open(context, const TelebirrTransferScreen()),
                    ),
                    _QuickAction(
                      icon: Icons.phone_android_rounded,
                      label: 'Telecom',
                      onTap: () => _open(context, const TelecomServicesScreen()),
                    ),
                    _QuickAction(
                      ...
                      children: [
                        ...
                        AppButton(
                          ...
                          onPressed: () {
                            ...
                            _open(context, LoanDetailScreen(loanId: loan.loanId));
                          },
                        ),
                      ],
                    ),
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Icon(
                                    ...
                                    color: item.priority == 'high' ? Colors.white : abayPrimary,
                                  ),
                                ),
                                const SizedBox(width: 12),
                                Expanded(
  ...
  Future<MemberHomeData> _loadHomeData(dynamic services, MemberSession session) async {
  ...
  void _maybeShowLiveNotification(List<AppNotification> notifications) {
    ...
    final isSecurityForegroundAlert =
        notification.type == 'suspicious_login' ||
        notification.type == 'account_locked' ||
        notification.type == 'account_unlocked' ||
        notification.title.toLowerCase().contains('login detected') ||
        notification.message.toLowerCase().contains('new login to your amhara bank mobile profile');
  ...
  void _openNotificationFromHome(AppNotification notification) {
    ...
    if (notification.type == 'school_payment_due' ||
        deepLink.startsWith('/payments/school')) {
      _open(context, const SchoolPaymentScreen());
      return;
    }
...
String _loanStatusLabel(String value) => value.replaceAll('_', ' ').toUpperCase();
...
List<_FeatureHighlight> _buildFeatureHighlights({
  ...
  final items = <_FeatureHighlight>[
    _FeatureHighlight(
      ...
      subtitle: 'Identity onboarding, Fayda review, and verification status are now available in-app.',
    ...
    _FeatureHighlight(
      ...
      subtitle: 'Talk to the bank directly and follow support replies in one place.',
    ...
    _FeatureHighlight(
      ...
      subtitle: 'Manage recurring school payments with due reminders, history, and optional auto-pay.',
    ...
    _FeatureHighlight(
      title: 'Auto payments',
      subtitle: 'Recurring rules now cover school fees, DSTV, rent, utilities, and savings transfers.',
    ...
    _FeatureHighlight(
      ...
      subtitle: 'Control account lock, device sessions, biometrics, and sensitive verification from one security center.',
    ...
    _FeatureHighlight(
      ...
      subtitle: 'Request a new ATM card or replacement card directly from the app.',
    ...
    _FeatureHighlight(
      ...
      subtitle: 'Change your phone number with verification and supporting identity checks.',
    ...
    _FeatureHighlight(
      ...
      subtitle: 'Submit nominee, joint-holder, or related-member requests with verification.',
    ...
    _FeatureHighlight(
      ...
      subtitle: 'Dynamic reminders now highlight school fees, utilities, autopay, and savings guidance.',
  ...
  if (hasActiveLoan) {
    items.insert(
      ...
      _FeatureHighlight(
        title: 'Loan tracker',
        subtitle: 'Track your application stage, repayment details, and next due date from the app.',
        icon: Icons.account_balance_wallet_outlined,
        badge: 'IMPROVED',
