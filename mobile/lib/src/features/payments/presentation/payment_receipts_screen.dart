    ...
    return FutureBuilder<_PaymentReceiptsViewData>(
      ...
      builder: (context, snapshot) {
        ...
        final filteredPaymentCases =
            _activeFilter == PaymentReceiptFilter.disputes ? paymentCases : paymentCases;
                ...
                children: [
                  ...
                  SectionCard(
                    ...
                    child: filteredConfirmedPayments.isEmpty
                        ...
                        : Column(
                            children: [
                              for (final payment in filteredConfirmedPayments) ...[
                                _ReceiptTile(
                                  title: payment.title,
                            ...
                            children: [
                              for (final request in filteredPaymentCases) ...[
                                _ReceiptTile(
                                  ...
                                  badgeLabel: _labelFromValue(request.receiptType),
                                  details: [
