...
import 'package:amhara_bank_mobile/src/features/auth/presentation/login_screen.dart';
import 'package:amhara_bank_mobile/src/features/profile/presentation/profile_screen.dart';
import 'package:amhara_bank_mobile/src/features/splash/presentation/splash_screen.dart';
import 'package:amhara_bank_mobile/widgets/amhara_bank_logo_compat.dart';
import 'package:amhara_bank_mobile/widgets/amhara_bank_mark.dart';
...
void main() {
  ...
  testWidgets('shareholder login flow shows branded home and profile screens', (
    ...
    await tester.pumpWidget(AmharaBankApp(services: AppServices.demo()));

    expect(find.byType(SplashScreen), findsOneWidget);
    expect(find.byType(AmharaBankMark), findsOneWidget);
    expect(find.byType(AmharaBankLogo), findsOneWidget);
